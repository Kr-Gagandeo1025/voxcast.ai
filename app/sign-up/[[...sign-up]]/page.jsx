...
export default function Page() {
  return(
        <div className="h-screen w-screen flex flex-col items-center justify-center bg-gradient-to-tr from-stone-100 via-transparent to-lime-200 xl:px-12 py-2 px-4">
          <HomeTopBar/>
